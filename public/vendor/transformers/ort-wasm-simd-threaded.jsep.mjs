var ortWasmThreaded = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var SharedArrayBuffer =
      globalThis.SharedArrayBuffer ?? new WebAssembly.Memory({ initial: 0, maximum: 0, pc: !0 }).buffer.constructor
    const ha =
      (a) =>
      async (...b) => {
        try {
    ...
    e.jsepInit = (a, b) => {
      if ('webgpu' === a) {
        ...
        e.webnnRegisterMLConstant = (d, f, g, h, l, m) => c.registerMLConstant(d, f, g, h, l, e.Eb, m)
    ...
    if (n) {
      var fs = require('fs'),
        pa = require('path')
      import.meta.url.startsWith('data:') || (v = pa.dirname(require('url').fileURLToPath(import.meta.url)) + '/')
      oa = (a) => {
        a = qa(a) ? new URL(a) : a
        ...
        try {
          ...
          if ('load' === d) {
            ...
            'setimmediate' !== c.target &&
              ('checkMailbox' === d ? Ja && Ra() : d && (x(`worker: received unknown command ${d}`), x(c)))
        } catch (f) {
          throw (Sa(), f)
        }
      }
    ...
    var Dc = {
      ...
      835036: (a, b, c) => {
        e.jb('Transpose', a, { perm: b ? Array.from(H().subarray(Number(b) >>> 0, Number(c) >>> 0)) : [] })
      },
      835160: (a, b, c, d) => {
      ...
      841854: (a, b, c, d, f) => {
        e.jb('Pad', a, { mode: b, value: c, pads: d ? Array.from(H().subarray(Number(d) >>> 0, Number(f) >>> 0)) : [] })
      },
      841997: (a, b, c, d, f, g) => {
      ...
      842522: (a, b, c, d, f) => {
        e.jb('GridSample', a, { align_corners: b, mode: M(c), padding_mode: M(d), format: f ? 'NHWC' : 'NCHW' })
      },
      842692: (a, b, c, d, f) => {
        e.jb('GridSample', a, { align_corners: b, mode: M(c), padding_mode: M(d), format: f ? 'NHWC' : 'NCHW' })
      },
      ...
      843391: (a, b, c, d, f, g, h, l, m, p, r, u, w, y, ba, Vd) => {
        e.jb('Conv', a, {
          ...
          activation: M(y),
          activation_params: ba ? Array.from(Ga().subarray(Number(ba) >>> 0, Number(Vd) >>> 0)) : []
        })
      },
      843975: (a) => {
        e.jb('Gelu', a, void 0)
      ...
      844593: (a, b, c, d, f, g) => {
        e.jb('MultiHeadAttention', a, { numHeads: b, isUnidirectional: c, maskFilterValue: d, scale: f, doRotary: g })
      },
      844752: (a, b) => {
        e.jb('QuickGelu', a, { alpha: b })
      },
      844816: (a, b, c, d, f) => {
        e.jb('RotaryEmbedding', a, { interleaved: !!b, numHeads: c, rotaryEmbeddingDim: d, scale: f })
      },
      844955: (a, b, c) => {
    ...
    function yb(a, b, c, d, f) {
      ...
      T(a, { name: b, fromWireType: f, toWireType: h, Cb: U, readValueFromPointer: md(b, c, 0 !== d), Db: null })
    }
    function zb(a, b, c) {
      function d(g) {
        var h = I()[(g >>> 2) >>> 0]
      ...
      T(a, {
        ...
        fromWireType: function (c) {
          for (var d = I()[(c >>> 2) >>> 0], f = c + 4, g, h = f, l = 0; l <= d; ++l) {
            var m = f + l
            if (l == d || 0 == F()[m >>> 0])
              ((h = M(h, m - h)), void 0 === g ? (g = h) : ((g += String.fromCharCode(0)), (g += h)), (h = m + 1))
          }
          Y(c)
          return g
        },
        toWireType: function (c, d) {
          ...
          if (f) fd(d, l, g + 1)
            ...
            for (f = 0; f < g; ++f) {
              ...
              if (255 < m) throw (Y(h), new S('String has UTF-16 code units that do not fit in 8 bits'))
              F()[(l + f) >>> 0] = m
            }
      ...
      T(a, {
        ...
        fromWireType: (l) => {
          for (var m = I()[(l >>> 2) >>> 0], p, r = l + 4, u = 0; u <= m; ++u) {
            var w = l + 4 + u * b
            if (u == m || 0 == h(w))
              ((r = d(r, w - r)), void 0 === p ? (p = r) : ((p += String.fromCharCode(0)), (p += r)), (r = w + b))
          }
          Y(l)
          return p
        },
    ...
    var Ed = (a, b) => {
        var c = jd[a]
        if (void 0 === c) throw ((a = Dd(a)), (c = R(a)), Y(a), new S(`${b} has unknown type ${c}`))
        return c
      },
      Fd = (a, b, c) => {
        var d = []
    ...
    function Sd(a) {
      if (!A) {
        if (0 === Z) {
          ...
          c = !0
          b || ((Z = 1), (t = Qd()), 'undefined' != typeof MainLoop && MainLoop.Pb && MainLoop.pause(), Gd(() => Ud(t)))
        } else 2 === Z ? ((Z = 0), Gd(Wd), Y(t), (t = null), Pd.forEach(zd)) : L(`invalid state: ${Z}`)
        return Kd
      }
    }
    function Ec(a) {
    ...
    var ae = (a) => {
      ...
      be = (a, b) => {
        for (var c = Array(a), d = 0; d < a; ++d) c[d] = Ed(I()[((b + 4 * d) >>> 2) >>> 0], 'parameter ' + d)
        return c
      },
    ...
    function Qb(a, b, c) {
      ...
      d.Tb ||
        (l.push('emval_returnValue'), m.push(Fd), (f += '  return emval_returnValue(retType, destructorsRef, rv);\n'))
      l.push(f + '};\n')
      a = de(l)(...m)
    ...
    function sc(a) {
      ...
      for (var c = 1; 4 >= c; c *= 2) {
        ...
        a: {
          d =
            ((Math.min(4294901760, 65536 * Math.ceil(Math.max(a, d) / 65536)) - z.buffer.byteLength + 65535) / 65536) |
            0
          try {
            z.grow(d)
            E()
    ...
    var me = () => {
        L('Cannot use convertFrameToPC (needed by __builtin_return_address) without -sUSE_OFFSET_CONVERTER')
        return 0
      },
      ne = {},
      oe = (a) => {
    ...
    var Cd = [Cc, Qc, bd, gb, hb, ib, jb, kb, lb, mb, nb, ob, pb, qb, rb, sb, dc, ec, fc, vc, wc, yc, zc, Ac, Bc],
      bb,
      K
    ;(async function () {
      function a(d, f) {
    ...
    e._OrtAppendExecutionProvider = (a, b, c, d, f) => (e._OrtAppendExecutionProvider = K.Ia)(a, b, c, d, f)
    ...
    e._OrtGetInputOutputMetadata = (a, b, c, d) => (e._OrtGetInputOutputMetadata = K.Pa)(a, b, c, d)
