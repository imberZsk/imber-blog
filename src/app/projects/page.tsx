    ...
    <div className={cn('mx-auto max-w-6xl px-4 py-8 sm:px-6', PADDING_TOP)}>
      ...
      >
        {projectsConfig.map((project, index) => (
          <Link key={project.id} href={project.link} className="group block" target="_blank" rel="noreferrer">
            <Card className="bg-card hover:border-foreground/30 h-full overflow-hidden transition-colors">
