...
<CodeSandbox code={`function controlConcurrent(arr, max) {
...
<CodeSandbox code={`// function new(fn){
//   // const newObj = {}
...
<CodeSandbox code={`// function instanceof(a,b){
//   const l = a.__proto__
//   const r = b.prototype
//   while(true){
//     if(l===null){
...
<CodeSandbox code={`// function deepClone(obj, cache = new WeakMap()) {
...
<CodeSandbox code={`class LRUCache {
...
<CodeSandbox
  code={`function arrayToTree(items, id = null, link = 'parentId') {
  return items
