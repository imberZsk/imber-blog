      ...
      <div className="space-y-4">
        {filteredPosts.map((post, index) => (
          ...
          >
            <Link
              href={post.href}
              className="group block space-y-2 rounded-md border border-zinc-200/50 bg-white/80 p-4 transition-all hover:border-zinc-300 hover:bg-zinc-50/90 dark:border-zinc-800/50 dark:bg-zinc-950/80 dark:hover:border-zinc-700 dark:hover:bg-zinc-900/90"
            >
