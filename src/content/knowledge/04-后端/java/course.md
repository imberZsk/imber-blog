...
> 前端 → 全栈，主攻 Java，边学边看 cyt 真实代码
> 开始日期：2026/06/09

## 学习方式

- 边讲边看真实代码（cyt-projects）
- 每个概念配前端类比，降低上手成本
- 文档按需记录，学到该记的再写
...
│
├── # 阶段五：cyt 项目代码导读（重点）
├── 17-cyt后端项目总览.md            # 架构、服务清单
├── 18-cyt-basic项目结构.md          # biz/client/common/service
├── 19-读懂一个完整接口.md           # Controller→数据库全追踪
├── 20-公共组件cyt-common.md         # 工具类、统一返回
│
├── # 阶段六：微服务架构
...
- cyt 项目：`/Users/imber/Desktop/work/cyt/cyt-projects`
