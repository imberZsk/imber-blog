...
```bash
cd /Users/imber/Desktop/knowledge/Agent/43-项目-企业知识库RAG/lab
...
页面左侧点击 `导入 agent小册`，会读取当前 Agent 知识目录：

```text
/Users/imber/Desktop/knowledge/Agent
```
...
| POST | `/api/knowledge/import-agent-manual` | 批量导入本地 `agent小册` |
