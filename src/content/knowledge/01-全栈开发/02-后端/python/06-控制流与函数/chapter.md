...
## 5.5 坑 5：`range` 是左闭右开，且不含 C 式 for
...
> DIAGRAM_DESCRIPTION：中心节点为“Python（5）- 控制流与函数”，一级分支使用本文主要章节，至少覆盖核心概念、适用场景、实现要点、选型取舍和常见误区。
