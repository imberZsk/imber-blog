...
├── 17-Spring事务与Transactional.md  # 事务边界、回滚与常见失效场景
│
├── # 阶段五：demo 项目代码导读（重点）
...
│
├── # 补充资料（与正文同级，不再嵌套目录）
├── 34-Java陷阱对照.md             # A1 前端转 Java 高频四类翻车
├── 35-Java常用命令.md             # A2 java/javac/mvn ↔ node/npm 对照
├── 36-JS到Java速查表.md           # A3 JS/TS↔Java 双向对照，卡壳时翻
├── 37-Java疑问记录.md             # 已验证问题与结论
├── 38-Java-Demo运行指南.md        # 编译、运行和排错
└── 39-Java全栈项目结构速查.md     # 模块职责与依赖方向
```
