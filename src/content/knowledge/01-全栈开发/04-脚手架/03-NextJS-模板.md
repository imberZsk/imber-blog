...
> 读完后，你应能完成以下任务：
> - 绘制“工程化脚手架（03） - NextJS 模板 / 概述”的关键对象与数据流，解释“Imber CLI 的 NextJS 模板是一个现代化的 React 全栈开发模板，基于 Next.js 14+ 和最新的 React 18 特性构建。”，并用源码位置、日志或 Trace 标注证据。
> - 为“工程化脚手架（03） - NextJS 模板 / 模板特性”设计正常与异常输入，验证“TypeScript：完整的类型安全支持”，输出首个偏差位置与回归测试结果。
> - 实现“工程化脚手架（03） - NextJS 模板 / 补充结论 1”的最小代码或配置，检验“PWA 支持：渐进式 Web 应用”，输出命令、结果与 Diff，并说明不适用边界。
...
- **概述**：Imber CLI 的 NextJS 模板是一个现代化的 React 全栈开发模板，基于 Next.js 14+ 和最新的 React 18 特性构建。
