...
> 读完后，你应能解释“5.1 读环境变量：os.environ ≈ process.env”，复现“5.2 本地用 .env 文件：python-dotenv ≈ 前端的 dotenv”的最小实现，并用“5.3 进阶：用 Pydantic Settings 集中管理配置（推荐，FastAPI 生态标配）”检查结果与失败边界。
