# React 源码（02） - React 源码流程预览

> 读完后，你应能解释“2.1 React 核心包”，复现“2.2 渲染器相关”的最小实现，并用“2.2 渲染器相关”检查结果与失败边界。
...
- **React 大致流程**：React 全流程大约有以下几步：
- **React 包一览**：大约可以分为六大类：核心包、服务端渲染、渲染器、开发工具、工具包、试验性功能、绑定层；
