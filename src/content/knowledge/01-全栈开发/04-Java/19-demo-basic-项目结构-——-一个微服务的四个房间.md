# Java（19） - demo-basic 项目结构 —— 一个微服务的四个房间

> 读完后，你应能解释“2.1 demo-basic-common —— 共享 DTO 房间”，复现“2.2 demo-basic-service —— 真正干活的房间”的最小实现，并用“2.3 demo-basic-client —— 对外接口房间（最容易被前端误解的一个）”检查结果与失败边界。
