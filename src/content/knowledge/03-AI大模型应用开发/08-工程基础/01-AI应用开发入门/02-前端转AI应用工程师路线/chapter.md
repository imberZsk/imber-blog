...
- **先确定方向：你不是转算法岗**：前端工程师 + AI 应用开发能力 = AI 应用工程师 / AI 全栈工程师
- **前端同学的优势**：前端不是包袱，反而是 AI 应用方向的天然优势。

## 可视化规格

> VISUAL_STRATEGY：截图（Screenshot）
> SCREENSHOT_DESCRIPTION：围绕“Agent 工程（2）- 前端转 AI 应用工程师路线”展示操作入口、关键配置、成功状态和一处典型错误；账号、密钥、租户与业务数据必须脱敏。
