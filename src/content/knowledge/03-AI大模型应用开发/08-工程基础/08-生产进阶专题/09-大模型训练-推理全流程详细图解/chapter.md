...
- **落地建议**：格式稳定性问题可考虑 structured output 或微调。

## 可视化规格

> VISUAL_STRATEGY：截图（Screenshot）
> SCREENSHOT_DESCRIPTION：围绕“Agent 工程（90）- 大模型训练、推理全流程详细图解”展示操作入口、关键配置、成功状态和一处典型错误；账号、密钥、租户与业务数据必须脱敏。
