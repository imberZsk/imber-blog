...
> 读完你能：把合同、法律、客服、教育、车联网、多模态素材中心这些看似不同的项目，统一拆成“场景、架构、难点、指标、表达”五件事。
...
1. 垂直行业项目不要背名字，要拆业务问题、输入数据、核心链路、难点和指标。
2. 合同、法律项目重证据；客服项目重路由和兜底；车联网项目重工具确认。
3. 教育项目重状态和安全边界；多模态项目重素材转文本和证据定位。
4. 所有项目都要能讲清：哪些事模型做，哪些事代码硬控。
5. 简历表达要落到动作、取舍和指标，少堆 LangChain、Milvus、Agent 这类名词。

## 可视化规格

> VISUAL_STRATEGY：架构图（Architecture）
> DIAGRAM_DESCRIPTION：围绕“进阶：垂直行业 Agent 项目案例”画出系统边界、核心组件、依赖方向、数据或控制流、外部服务和故障降级路径；权限边界与持久化位置必须明确。
