...
`49-高频面试题-RAG.md` —— 简历把话头递出去了，接下来三篇面试题就是教你怎么接住。先从必考的 RAG 开始，按真题逐个拆"怎么答得有干货"。
...
> SCREENSHOT_DESCRIPTION：围绕“Agent 工程（48）- AI 应用工程师简历”展示操作入口、关键配置、成功状态和一处典型错误；账号、密钥、租户与业务数据必须脱敏。
