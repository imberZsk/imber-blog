...
如果说前面都是铺垫，这一章就是 Paperclip 的心脏。
**理解了心跳，你就理解了 AI 员工的一切行为。
**
...
回顾第 01 章的「记忆碎片」模型：Agent 像电影里那个没有持久记忆的男主，
单次很强但不记事。
心跳就是反复把它叫醒、塞给它「这是你、这是你在干的事、接下来做这个」的便利贴。
...
- ❌ **被卡住默不作声**
→ 必须把 blocker 写进评论、置 blocked、上报经理。
「沉默地卡着」是最糟的状态。
