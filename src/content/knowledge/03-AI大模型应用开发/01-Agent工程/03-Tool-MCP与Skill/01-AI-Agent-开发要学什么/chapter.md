# Agent 工程（53）- AI Agent 开发要学什么？

> 读完你能：建立一张 Agent 开发能力地图，知道先学什么、后学什么，以及哪些概念只是包装名词。
> 来源：`吃透 AI Agent 开发` 截图目录第 1 篇，2025/12/21，可试读 98%
> 导入与重写日期：2026/07/07
...
> SCREENSHOT_DESCRIPTION：围绕“Agent 工程（53）- AI Agent 开发要学什么？”展示操作入口、关键配置、成功状态和一处典型错误；账号、密钥、租户与业务数据必须脱敏。
