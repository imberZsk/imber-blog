...
下面每题给三层：**一句话答**（能脱口而出的）、**展开**（2-4 句体现深度）、**加分项**（说出来面试官高看一眼的点）。先盖住答案自己说一遍，再对照。配套 `demos/49-interview-rag/quiz.py` 能随机抽题自测。
...
```bash
cd demos/49-interview-rag
python3 quiz.py           # 随机抽 5 题，先自己答再看参考
