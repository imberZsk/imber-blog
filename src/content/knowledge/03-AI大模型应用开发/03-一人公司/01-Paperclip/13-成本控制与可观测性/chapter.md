# Paperclip（12）- 成本控制与可观测性：钱花在哪、活干得怎样
...
成本和进度看明白了。但到现在我们的公司还跑在本地、只有自己能访问。下一章讲怎么把它从「本地玩具」变成「能长期运行、可远程访问」的真东西。👉 [13 · 部署与上线](../14-部署与上线/chapter.md)

## 可视化规格

> VISUAL_STRATEGY：架构图（Architecture）
> DIAGRAM_DESCRIPTION：围绕“Paperclip（12）- 成本控制与可观测性：钱花在哪、活干得怎样”画出系统边界、核心组件、依赖方向、数据或控制流、外部服务和故障降级路径；权限边界与持久化位置必须明确。
