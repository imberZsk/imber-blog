...
入门篇到此结束。你已经理解了 Paperclip 是什么、怎么跑、核心概念和架构。下一篇进入**进阶篇**，我们动手建出第一家真正能干活的公司。👉 [05 · 创建你的第一家公司](../06-创建你的第一家公司/chapter.md)

## 可视化规格

> VISUAL_STRATEGY：截图（Screenshot）
> SCREENSHOT_DESCRIPTION：围绕“Paperclip（4）- 架构总览：控制平面 vs 执行平面”展示操作入口、关键配置、成功状态和一处典型错误；账号、密钥、租户与业务数据必须脱敏。
