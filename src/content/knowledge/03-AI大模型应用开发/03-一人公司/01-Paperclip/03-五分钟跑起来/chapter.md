...
平台跑起来了，但你看到的还是一个空控制台。下一章我们先把「六大核心概念」过一遍，建立词汇表，后面建公司才不会晕。👉 [03 · 六大核心概念](../04-六大核心概念/chapter.md)

## 可视化规格

> VISUAL_STRATEGY：截图（Screenshot）
> SCREENSHOT_DESCRIPTION：围绕“Paperclip（2）- 五分钟跑起来：本地启动你的控制台”展示操作入口、关键配置、成功状态和一处典型错误；账号、密钥、租户与业务数据必须脱敏。
