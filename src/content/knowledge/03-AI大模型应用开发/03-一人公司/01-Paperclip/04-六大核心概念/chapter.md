...
下一章，我们从「概念」往下走一层，看看支撑这一切的**技术架构**长什么样。👉 [04 · 架构总览](../05-架构总览/chapter.md)

## 可视化规格

> VISUAL_STRATEGY：架构图（Architecture）
> DIAGRAM_DESCRIPTION：围绕“Paperclip（3）- 六大核心概念”画出系统边界、核心组件、依赖方向、数据或控制流、外部服务和故障降级路径；权限边界与持久化位置必须明确。
