# AI 大模型应用面试题（4）- Elasticsearch、BM25 与混合检索（第 31～40 题）
...
> DIAGRAM_DESCRIPTION：围绕“AI 大模型应用面试题（4）- Elasticsearch、BM25 与混合检索（第 31～40 题）”展示输入、关键处理步骤、主要分支、输出和失败回退；箭头必须标明数据流或控制流方向。
