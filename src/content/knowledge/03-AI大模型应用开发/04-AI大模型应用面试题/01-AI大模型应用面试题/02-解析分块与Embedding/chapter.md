# AI 大模型应用面试题（2）- 文档解析、分块与 Embedding（第 11～20 题）
...
> DIAGRAM_DESCRIPTION：围绕“AI 大模型应用面试题（2）- 文档解析、分块与 Embedding（第 11～20 题）”画出系统边界、核心组件、依赖方向、数据或控制流、外部服务和故障降级路径；权限边界与持久化位置必须明确。
